function [features, empmean, CRFDATA, boxesalldata] = coo_bb(features, empmean, imlist, CRFDATA, varnameR,  threshold, ALLPATHS, train, boxesalldata, ind_classes, Rstats)
...
%                                                                                 ind_class2  = 14;
            ...
            nboxes2 = size(boxes2, 1);
                ...
                %             line([x11 x11 x21 x21 x11]', [y11 y21 y21 y11 y11]', 'color', 'w', 'linewidth', 2.5);
                            ...
                            overlap = computeOverlapping(boxmask1, boxmask2, varnameR);
                            score = -1;
                            if overlap >= 0.5
%                                 score = overlap;
                                Pair = [Pair; [k1, k2]];
                                Pair_Score = [Pair_Score; overlap*Rstats];
                                if train
